...
// All menu items
const allMenuItems = [
  { icon: LayoutDashboard, label: "Dashboard TU", href: "/dashboard/admin-tu" },
  { icon: Users, label: "Manajemen Siswa", href: "/dashboard/students" },
  { icon: UserCheck, label: "Manajemen Guru", href: "/dashboard/teachers" },
  { icon: BookOpen, label: "Akademik", href: "/dashboard/academic" },
  { icon: Calendar, label: "Jadwal", href: "/dashboard/schedule" },
  { icon: ClipboardCheck, label: "Absensi", href: "/dashboard/attendance" },
  { icon: FileText, label: "Penilaian & Raport", href: "/dashboard/grades" },
  { icon: MessageSquare, label: "BK & Konseling", href: "/dashboard/counseling" },
  { icon: Award, label: "Prestasi", href: "/dashboard/achievements" },
  { icon: Users, label: "Ekstrakurikuler", href: "/dashboard/extracurricular" },
  { icon: Calendar, label: "Agenda Kalender", href: "/dashboard/calendar-events" },
  { icon: Bell, label: "CMS Berita", href: "/dashboard/news-cms" },
  { icon: Bell, label: "Pengumuman", href: "/dashboard/announcements" },
  { icon: FolderOpen, label: "Arsip Dokumen", href: "/dashboard/archives" },
  { icon: BarChart3, label: "Laporan & Export", href: "/dashboard/reports" },
