...
export const StudentManagementDashboard = () => {
  ...
  const filteredStudents = useMemo(() => {
    return students.filter((s) => {
      ...
      const matchStatus =
        filterStatus === "Semua" || (s.status || "Aktif") === filterStatus;
  ...
  // ── Handler submit form untuk tambah/edit ──────────────────────────────
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    const formData = new FormData(e.currentTarget);

    const newStudent: Student = {
      id: selectedStudent?.id || `manual-${Date.now()}-${Math.random()}`,
  ...
  return (
    <div className="space-y-6 pb-10">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm" style={{ color: COLORS.secondary }}>
            Kelola data, status, dan informasi profil siswa.
          </p>
        </div>
        <div className="flex gap-2 flex-wrap">
          <button
            onClick={() =>
              window.open(
                "https://docs.google.com/spreadsheets/d/1xg1keWXGRB4h8HB_ZxmFh1q9sPQBGx74HAUgOAcVL2Q/edit?gid=31445495#gid=31445495",
                "_blank",
              )
            }
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 bg-white border rounded-lg hover:bg-gray-50 transition-colors shadow-sm text-xs font-medium disabled:opacity-40"
            style={{ borderColor: COLORS.grayMedium, color: COLORS.primary }}
      ...
      {importStatus === "loading" && (
        <div
          className="flex items-center gap-2 text-xs px-3 py-2 rounded-lg border w-fit bg-amber-50"
          style={{ borderColor: "#f59e0b44", color: "#92400e" }}
        >
      ...
      {importStatus === "error" && (
        <div
          className="flex items-start gap-2 text-xs px-3 py-2.5 rounded-lg border max-w-2xl bg-red-50"
          style={{ borderColor: "#f8717144", color: "#991b1b" }}
        >
      ...
      {(importStatus === "success" || importStatus === "idle") && (
        <div
        ...
        >
          ...
          <span>
            Data otomatis dimuat dari <strong>Google Sheets</strong>
            {lastSyncAt &&
              ` · sync terakhir ${format(parseISO(lastSyncAt), "dd MMM HH:mm", { locale: id })}`}
      ...
      >
        ...
        >
          ...
          <div className="flex gap-1">
            <button
              className="px-3 py-1 rounded border bg-white text-gray-500 disabled:opacity-50 text-sm"
              disabled
            >
              Sebelumnya
            </button>
            ...
            <div className="flex min-h-full items-center justify-center p-4">
              ...
              >
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm opacity-90">
                          {selectedStudent
                            ? `${selectedStudent.nis} • ${selectedStudent.kelas}`
                ...
                {isEditMode ? (
                  ...
                  >
                    <h3
                      className="text-lg font-bold pb-2 border-b border-gray-100"
                      style={{ color: COLORS.primary }}
                    >
                      Form Data Siswa
                    </h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-1">
                        ...
                        <input
                          type="text"
                          name="namaLengkap"
                          defaultValue={selectedStudent?.namaLengkap || ""}
                          required
                      ...
                      <div className="space-y-1">
                        ...
                        <select
                          name="jenisKelamin"
                          defaultValue={selectedStudent?.jenisKelamin || "L"}
                          className="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-[#d9ab3f]/40 focus:outline-none"
                        >
                      ...
                      <div className="space-y-1">
                        ...
                        <input
                          type="text"
                          name="tempatLahir"
                          defaultValue={selectedStudent?.tempatLahir || ""}
                          className="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-[#d9ab3f]/40 focus:outline-none"
                        />
                      </div>
                      <div className="space-y-1">
                        ...
                        <input
                          type="text"
                          name="noTelp"
                          defaultValue={selectedStudent?.noTelp || ""}
                          className="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-[#d9ab3f]/40 focus:outline-none"
                        />
                      </div>
                      <div className="space-y-1">
                    ...
                    <div className="space-y-1">
                      ...
                      <textarea
                        ...
                        className="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-[#d9ab3f]/40 focus:outline-none h-20 resize-none"
                      ></textarea>
                    </div>

                    <h4
                      className="text-xs uppercase tracking-wider font-semibold pt-4 border-t border-gray-100 flex items-center gap-2"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="space-y-1">
                        ...
                        <input
                          type="text"
                          name="namaWali"
                          defaultValue={selectedStudent?.namaWali || ""}
                          className="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-[#d9ab3f]/40 focus:outline-none"
                        />
                      </div>
                      <div className="space-y-1">
                        ...
                        <input
                          type="text"
                          name="pekerjaanWali"
                          defaultValue={selectedStudent?.pekerjaanWali || ""}
                          className="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-[#d9ab3f]/40 focus:outline-none"
                        />
                      </div>
                      <div className="space-y-1">
                        ...
                        <input
                          type="text"
                          name="noTelpWali"
                          defaultValue={selectedStudent?.noTelpWali || ""}
                          className="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-[#d9ab3f]/40 focus:outline-none"
                        />
                      </div>
                    </div>
                    ...
                    <div className="p-4 bg-gray-50 border-t flex justify-end items-center gap-3">
                      <button
                        type="button"
                        onClick={() => setIsModalOpen(false)}
                        className="px-4 py-2 rounded-lg text-gray-600 bg-white border border-gray-300 hover:bg-gray-100 transition-colors text-sm font-medium"
                      >
                        Batal
                      </button>
                      <button
                        ...
                        className="px-4 py-2 rounded-lg text-white transition-colors text-sm font-medium flex items-center gap-2 shadow-sm hover:opacity-90 disabled:opacity-70"
                  ...
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div className="space-y-5">
                        <div>
                          ...
                          <div className="space-y-3">
                            ...
                            {selectedStudent?.jenisKelamin && (
                              <div>
                                <p className="text-xs text-gray-500">
                                  Jenis Kelamin
                                </p>
                                <p className="text-sm font-medium text-gray-900">
                                  {selectedStudent.jenisKelamin === "L"
                                    ? "Laki-laki"
                                    : selectedStudent.jenisKelamin === "P"
                                      ? "Perempuan"
                                      : selectedStudent.jenisKelamin}
                                </p>
                              </div>
                              ...
                              <div>
                                ...
                                <p className="text-sm font-medium text-gray-900 flex items-center gap-1">
                                  ...
                                  selectedStudent.tanggalLahir
                                    ? ", "
                                    : ""}
                                  {formatDate(selectedStudent.tanggalLahir)}
                                </p>
                              </div>
                            )}
                      ...
                      <div className="space-y-5">
                        ...
                        {(selectedStudent?.namaWali ||
                          selectedStudent?.pekerjaanWali ||
                          selectedStudent?.noTelpWali) && (
                          <div>
                            <h4
                              className="text-xs uppercase tracking-wider font-semibold mb-3 flex items-center gap-2"
                              style={{ color: COLORS.accentLight }}
                    ...
                    <div className="p-4 bg-gray-50 border-t flex justify-between items-center gap-3 mt-6">
                      <button
                        onClick={() => {
                          setIsModalOpen(false);
                          navigate("/dashboard/student-cards");
                        }}
